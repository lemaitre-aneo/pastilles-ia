...
| **Changement d'angle**: le traitement change (partir d'un cas d'usage, d'une idée reçue, du mécanisme) mais l'axe reste | Reprise du brouillon écrit sous cet angle: il existe presque toujours, les cinq angles ayant été rédigés. Zéro sous-agent. Fan-out sous angle imposé seulement si ce brouillon manque. |
