...
Ce qui reste ferme, parce que ce sont des contraintes de diffusion et non des goûts: une seconde image dans son propre fichier, le mécanisme des deux premiers paragraphes et jamais la conclusion, un seul mécanisme par schéma, des libellés courts en français, et surtout la **lisibilité à 560 pixels de large sur téléphone**. C'est elle qui borne le reste: le format va du 4:3 au portrait 4:5, le 16:9 est exclu (les libellés s'y écrasent, et c'est aussi le format qui distingue le schéma de l'illustration-titre à l'extraction), et la densité se juge à ce que l'oeil doit démêler plutôt qu'à un nombre de boites.
