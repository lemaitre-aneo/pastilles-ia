...
- Choisis la FORME d'après le mécanisme, pas par habitude: flux d'étapes, boucle ou cycle, comparaison en colonnes, couches empilées, anatomie d'un objet dont on nomme les parties, matrice à deux axes, entonnoir, zones et périmètre, chronologie, balance, arborescence, ou toute autre forme qui sert mieux ce que tu expliques. Tu es libre, et c'est voulu: un enchainement de boites imposé à un mécanisme qui n'est pas une séquence le déguise en séquence.
