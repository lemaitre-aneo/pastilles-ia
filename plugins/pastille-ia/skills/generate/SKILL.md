...
Commence par trancher l'ampleur, comme le demande la spec partagée, section « Faire évoluer une pastille »: retouche de surface, réagencement, ou demande structurelle ? La question qui sépare les deux dernières: as-tu besoin de matière que tu n'as pas ?
...
- Retouches et réagencements: ils restent dans ce skill (étape 6), et le réagencement ne relance aucun sous-agent. Le réflexe d'appeler `refine` dès que l'utilisateur demande une modification est l'erreur la plus fréquente: `refine` réhydrate un contexte perdu, or ici il est intact.
